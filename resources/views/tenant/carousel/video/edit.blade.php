...
<div class="container my-4">
    ...
    {{-- Upload form --}}
    <form action="{{ route('tenant.carousel.video.store', ['tenant' => tenant('id')]) }}"
          method="POST"
        ...
        <div class="mb-3">
            <label for="video" class="form-label">Upload Crealor Video</label>
    ...
    <form action="{{ route('tenant.carousel.video.clear', ['tenant' => tenant('id')]) }}"
          method="POST"
